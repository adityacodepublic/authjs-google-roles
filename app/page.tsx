import SignOutButton from "@/components/auth/auth-control/signout-button";
...
const StartPage = async () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-full w-full bg-slate-800">
      ...
      <SignOutButton className="absolute top-5 right-6 rounded-2xl opacity-80 text-white text-opacity-100 hover:opacity-100">
        Sign Out
      </SignOutButton>
